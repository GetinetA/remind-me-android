...
/**
 * Simple reminders database access helper class. Defines the basic CRUD operations
 * for the reminder application, and gives the ability to list all reminders as well as
...
public class RemindersDbAdapter {
    ...
    /**
     * Create a new reminder using the title and body provided. If the reminder is
